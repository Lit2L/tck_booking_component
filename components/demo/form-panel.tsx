	...
	return (
		<form className='flex flex-col gap-5 w-[360px]'>
			...
			<div className='flex flex-col space-y-1.5'>
				...
				<Textarea id='notes' placeholder='Please share anything that will help prepare for our meeting' />
			</div>
			{hasGuests && (
				<>
			...
			<p className='text-gray-11 text-xs my-4'>
				By proceeding, you agree to our <span className='text-gray-12'>Terms</span> and{' '}

	...
	return (
		<main className='flex min-h-screen flex-col py-24 px-5 gap-8 max-w-5xl mx-auto'>
			<div className='flex flex-col gap-2 items-center lg:px-10'>
				<h1 className='font-bold text-4xl'>Tiger Club Kickboxing</h1>
				<h2 className='font-medium text-xl text-muted-foreground text-center px-10'>
					<Balancer> The best kickboxing club in the world! </Balancer>
				</h2>
			</div>
			<div className='flex flex-col gap-2 items-center'>
				<div className='flex gap-4 items-center'>
					<Button asChild>
						<Link href='https://github.com/damianricobelli/shadcn-cal-com' target='_blank'>
